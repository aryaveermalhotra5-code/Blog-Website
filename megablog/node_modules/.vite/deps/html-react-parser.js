...
//#region node_modules/html-dom-parser/lib/client/constants.js
var require_constants$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	exports.CASE_SENSITIVE_TAG_NAMES_MAP = [
		"animateMotion",
		"animateTransform",
		"clipPath",
		"feBlend",
...
function cloneNode(node, recursive = false) {
	let result;
	if (isText(node)) result = new Text$1(node.data);
	else if (isComment(node)) result = new Comment$1(node.data);
	else if (isTag(node)) {
		const children = recursive ? cloneChildren(node.children) : [];
		const clone = new Element$1(node.name, { ...node.attribs }, children);
...
var Node, DataNode, Text$1, Comment$1, ProcessingInstruction$1, NodeWithChildren, CDATA, Document, Element$1;
var init_node = __esmMin((() => {
	...
	Text$1 = class extends DataNode {
		type = ElementType.Text;
		get nodeType() {
			return 3;
		}
	};
	Comment$1 = class extends DataNode {
		type = ElementType.Comment;
		get nodeType() {
			return 8;
		}
	};
	ProcessingInstruction$1 = class extends DataNode {
	...
	Element$1 = class extends NodeWithChildren {
		name;
		attribs;
		type;
		/**
...
var dist_exports = /* @__PURE__ */ __exportAll({
	...
	ProcessingInstruction: () => ProcessingInstruction$1,
	Text: () => Text$1,
	cloneNode: () => cloneNode,
	default: () => DomHandler,
	...
	DomHandler = class {
		...
		*/
		...
		onopentag(name, attribs) {
			const element = new Element$1(name, attribs, void 0, this.options.xmlMode ? ElementType.Tag : void 0);
...
//#endregion
//#region node_modules/html-dom-parser/lib/client/utilities.js
var require_utilities$3 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var require_constants = require_constants$1();
	var domhandler = (init_dist(), __toCommonJS(dist_exports));
	var CARRIAGE_RETURN = "\r";
	var CARRIAGE_RETURN_REGEX = new RegExp(CARRIAGE_RETURN, "g");
	var CARRIAGE_RETURN_PLACEHOLDER = `__HTML_DOM_PARSER_CARRIAGE_RETURN_PLACEHOLDER_${Date.now().toString()}__`;
...
//#endregion
//#region node_modules/html-dom-parser/lib/client/domparser.js
var require_domparser$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var require_utilities$2 = require_utilities$3();
	var HTML = "html";
	var HEAD = "head";
	var BODY = "body";
	...
	/* v8 ignore start */
	var parseFromDocument = (html, tagName, trustedTypePolicy) => {
		throw new Error("This browser does not support `document.implementation.createHTMLDocument`");
	};
	var parseFromString = (html, tagName, trustedTypePolicy) => {
 ...
 /**
	...
	*/
	...
	var createNodeList = () => document.createDocumentFragment().childNodes;
	/* v8 ignore stop */
	/**
	...
	*/
	function domparser(html, trustedTypePolicy) {
		html = require_utilities$2.escapeSpecialCharacters(html);
		const firstTagName = FIRST_TAG_REGEX.exec(html)?.[1]?.toLowerCase();
		switch (firstTagName) {
			case HTML: {
				const doc = parseFromString(html);
				if (!require_utilities$2.hasOpenTag(html, HEAD)) {
					const element = doc.querySelector(HEAD);
					element?.parentNode?.removeChild(element);
				}
				if (!require_utilities$2.hasOpenTag(html, BODY)) {
			...
			case BODY: {
				...
				/* v8 ignore next */
				if (require_utilities$2.hasOpenTag(html, BODY) && require_utilities$2.hasOpenTag(html, HEAD)) return elements[0].parentNode?.childNodes ?? createNodeList();
				return elements;
			}
			/* v8 ignore start */
			default:
...
var require_html_to_dom = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperties(exports, {
		__esModule: { value: true },
		[Symbol.toStringTag]: { value: "Module" }
	});
	var require_utilities$1 = require_utilities$3();
	var require_domparser = require_domparser$1();
	...
	*/
	function HTMLDOMParser(html, options) {
		...
		return require_utilities$1.formatDOM(require_domparser.default(html, options?.trustedTypePolicy), null, directive);
	}
...
var require_cjs$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var COMMENT_REGEX = /\/\*[^*]*\*+([^/*][^*]*\*+)*\//g;
	var NEWLINE_REGEX = /\n/g;
...
var require_cjs = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var inline_style_parser_1 = __importDefault(require_cjs$1());
	/**
...
//#endregion
//#region node_modules/style-to-js/dist/index.js
var require_dist = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var style_to_object = require_cjs();
	...
	*/
	var skipCamelCase = (property) => !property || NO_HYPHEN_REGEX.test(property) || CUSTOM_PROPERTY_REGEX.test(property);
	/**
	* Replacer that capitalizes first character.
	*/
	var capitalize = (match, character) => character.toUpperCase();
	/**
	* Replacer that removes beginning hyphen of vendor prefix property.
	*/
	var trimHyphen = (match, prefix) => `${prefix}-`;
	/**
	* CamelCases a CSS property.
	*/
	var camelCase = (property, options = {}) => {
...
var require_utilities = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var style_to_js_1 = __importDefault(require_dist());
...
var require_dom_to_react = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	function normalizeDOMNodes(nodes) {
		for (const node of nodes) if (node.type === "tag" || node.type === "script" || node.type === "style") {
...
//#endregion
var Comment = import_lib.Comment;
var Element = import_lib.Element;
var ProcessingInstruction = import_lib.ProcessingInstruction;
var Text = import_lib.Text;
var attributesToProps = import_lib.attributesToProps;
var domToReact = import_lib.domToReact;
var htmlToDOM = import_lib.htmlToDOM;
export { Comment, Element, ProcessingInstruction, Text, attributesToProps, esm_default as default, domToReact, htmlToDOM };
