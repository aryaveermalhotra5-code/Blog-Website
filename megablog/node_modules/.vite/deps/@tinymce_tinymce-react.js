...
//#endregion
//#region node_modules/@tinymce/tinymce-react/lib/es2015/main/ts/components/EditorPropTypes.js
...
var eventPropTypes = {
	onActivate: import_prop_types.func,
	onAddUndo: import_prop_types.func,
	onBeforeAddUndo: import_prop_types.func,
	onBeforeExecCommand: import_prop_types.func,
	onBeforeGetContent: import_prop_types.func,
	onBeforeRenderUI: import_prop_types.func,
	onBeforeSetContent: import_prop_types.func,
	onBeforePaste: import_prop_types.func,
	onBlur: import_prop_types.func,
	onChange: import_prop_types.func,
	onClearUndos: import_prop_types.func,
	onClick: import_prop_types.func,
	onContextMenu: import_prop_types.func,
	onCommentChange: import_prop_types.func,
	onCompositionEnd: import_prop_types.func,
	onCompositionStart: import_prop_types.func,
	onCompositionUpdate: import_prop_types.func,
	onCopy: import_prop_types.func,
	onCut: import_prop_types.func,
	onDblclick: import_prop_types.func,
	onDeactivate: import_prop_types.func,
	onDirty: import_prop_types.func,
	onDrag: import_prop_types.func,
	onDragDrop: import_prop_types.func,
	onDragEnd: import_prop_types.func,
	onDragGesture: import_prop_types.func,
	onDragOver: import_prop_types.func,
	onDrop: import_prop_types.func,
	onExecCommand: import_prop_types.func,
	onFocus: import_prop_types.func,
	onFocusIn: import_prop_types.func,
	onFocusOut: import_prop_types.func,
	onGetContent: import_prop_types.func,
	onHide: import_prop_types.func,
	onInit: import_prop_types.func,
	onInput: import_prop_types.func,
	onKeyDown: import_prop_types.func,
	onKeyPress: import_prop_types.func,
	onKeyUp: import_prop_types.func,
	onLoadContent: import_prop_types.func,
	onMouseDown: import_prop_types.func,
	onMouseEnter: import_prop_types.func,
	onMouseLeave: import_prop_types.func,
	onMouseMove: import_prop_types.func,
	onMouseOut: import_prop_types.func,
	onMouseOver: import_prop_types.func,
	onMouseUp: import_prop_types.func,
	onNodeChange: import_prop_types.func,
	onObjectResizeStart: import_prop_types.func,
	onObjectResized: import_prop_types.func,
	onObjectSelected: import_prop_types.func,
	onPaste: import_prop_types.func,
	onPostProcess: import_prop_types.func,
	onPostRender: import_prop_types.func,
	onPreProcess: import_prop_types.func,
	onProgressState: import_prop_types.func,
	onRedo: import_prop_types.func,
	onRemove: import_prop_types.func,
	onReset: import_prop_types.func,
	onSaveContent: import_prop_types.func,
	onSelectionChange: import_prop_types.func,
	onSetAttrib: import_prop_types.func,
	onSetContent: import_prop_types.func,
	onShow: import_prop_types.func,
	onSubmit: import_prop_types.func,
	onUndo: import_prop_types.func,
	onVisualAid: import_prop_types.func,
	onSkinLoadError: import_prop_types.func,
	onThemeLoadError: import_prop_types.func,
	onModelLoadError: import_prop_types.func,
	onPluginLoadError: import_prop_types.func,
	onIconsLoadError: import_prop_types.func,
	onLanguageLoadError: import_prop_types.func,
	onScriptsLoad: import_prop_types.func,
	onScriptsLoadError: import_prop_types.func
};
var EditorPropTypes = __assign$2({
	apiKey: import_prop_types.string,
	licenseKey: import_prop_types.string,
	id: import_prop_types.string,
	inline: import_prop_types.bool,
	init: import_prop_types.object,
	initialValue: import_prop_types.string,
	onEditorChange: import_prop_types.func,
	value: import_prop_types.string,
	tagName: import_prop_types.string,
	tabIndex: import_prop_types.number,
	cloudChannel: import_prop_types.string,
	plugins: import_prop_types.oneOfType([import_prop_types.string, import_prop_types.array]),
	toolbar: import_prop_types.oneOfType([import_prop_types.string, import_prop_types.array]),
	disabled: import_prop_types.bool,
	readonly: import_prop_types.bool,
	textareaName: import_prop_types.string,
	tinymceScriptSrc: import_prop_types.oneOfType([
		import_prop_types.string,
		import_prop_types.arrayOf(import_prop_types.string),
		import_prop_types.arrayOf(import_prop_types.shape({
			src: import_prop_types.string,
			async: import_prop_types.bool,
			defer: import_prop_types.bool
		}))
	]),
	rollback: import_prop_types.oneOfType([import_prop_types.number, import_prop_types.oneOf([false])]),
	scriptLoading: import_prop_types.shape({
		async: import_prop_types.bool,
		defer: import_prop_types.bool,
		delay: import_prop_types.number
	})
}, eventPropTypes);
//#endregion
//#region node_modules/@tinymce/tinymce-react/lib/es2015/main/ts/TinyMCE.js
var getTinymce = function(view) {
	var global = view;
	return global && global.tinymce ? global.tinymce : null;
};
//#endregion
//#region node_modules/@tinymce/tinymce-react/lib/es2015/main/ts/Utils.js
...
var setMode = function(editor, mode) {
	if (editor !== void 0) if (editor.mode != null && typeof editor.mode === "object" && typeof editor.mode.set === "function") editor.mode.set(mode);
...
//#endregion
//#region node_modules/@tinymce/tinymce-react/lib/es2015/main/ts/ScriptLoader2.js
...
var createDocumentScriptLoader = function(doc) {
	...
	var loadScripts = function(items, success, failure) {
		...
		if (items.length === 0) {
			failureOrLog(/* @__PURE__ */ new Error("At least one script must be provided"));
			return;
		}
		var successCount = 0;
		var failed = false;
		...
		for (var _i = 0, items_1 = items; _i < items_1.length; _i++) {
			...
			if (existing) if (existing.done) loaded(item.src, existing.error);
...
//#endregion
//#region node_modules/@tinymce/tinymce-react/lib/es2015/main/ts/components/Editor.js
...
var Editor = function(_super) {
	...
	function Editor(props) {
		...
		_this.handleEditorChange = function(_evt) {
			...
			if (editor && editor.initialized) {
				...
				if (newContent !== _this.currentContent) {
					...
					if (isFunction(_this.props.onEditorChange)) _this.props.onEditorChange(newContent, editor);
				}
			}
		};
		...
		_this.initialise = function(attempts) {
			...
			if (!isInDoc(target)) {
				...
				else if (attempts < 100) setTimeout(function() {
			...
			var finalInit = __assign(__assign(__assign(__assign({}, _this.props.init), {
			...
			}), _this.props.licenseKey ? { license_key: _this.props.licenseKey } : {}), {
				setup: function(editor) {
					_this.editor = editor;
					_this.bindHandlers({});
					if (_this.inline && !isTextareaOrInput(target)) editor.once("PostRender", function(_evt) {
						editor.setContent(_this.getInitialValue(), { no_events: true });
					});
					if (_this.props.init && isFunction(_this.props.init.setup)) _this.props.init.setup(editor);
					if (_this.props.disabled) if (isDisabledOptionSupported(_this.editor)) _this.editor.options.set("disabled", _this.props.disabled);
					else _this.editor.mode.set("readonly");
				},
				init_instance_callback: function(editor) {
					...
					if (_this.props.init && isFunction(_this.props.init.init_instance_callback)) _this.props.init.init_instance_callback(editor);
				}
			});
			if (!_this.inline) target.style.visibility = "";
			if (isTextareaOrInput(target)) target.value = _this.getInitialValue();
			tinymce.init(finalInit);
		};
		_this.id = _this.props.id || uuid("tiny-react");
		_this.elementRef = import_react.createRef();
			...
			if (this.editor.initialized) {
				...
				if (typeof this.props.initialValue === "string" && this.props.initialValue !== prevProps.initialValue) {
					...
					localEditor_1.undoManager.transact(function() {
						...
						if (!_this.inline || localEditor_1.hasFocus()) for (var _i = 0, _a = [cursor, valueCursor]; _i < _a.length; _i++) {
							var bookmark = _a[_i];
							if (bookmark) try {
				...
				if (this.props.disabled !== prevProps.disabled) if (isDisabledOptionSupported(this.editor)) this.editor.options.set("disabled", this.props.disabled);
				else setMode(this.editor, this.props.disabled ? "readonly" : "design");
			}
		}
	};
	Editor.prototype.componentDidMount = function() {
		var _this = this;
		var _a, _b, _c, _d, _f;
		if (getTinymce(this.view) !== null) this.initialise();
		else if (Array.isArray(this.props.tinymceScriptSrc) && this.props.tinymceScriptSrc.length === 0) (_b = (_a = this.props).onScriptsLoadError) === null || _b === void 0 || _b.call(_a, /* @__PURE__ */ new Error("No `tinymce` global is present but the `tinymceScriptSrc` prop was an empty array."));
	...
	Editor.prototype.renderIframe = function() {
		return import_react.createElement("textarea", {
			ref: this.elementRef,
	...
	Editor.prototype.getScriptSources = function() {
		...
		return [{
			src: "https://cdn.tiny.cloud/1/".concat(apiKey, "/tinymce/").concat(channel, "/tinymce.min.js"),
			async,
			defer
		}];
	};
	...
	Editor.defaultProps = { cloudChannel: "8" };
	return Editor;
